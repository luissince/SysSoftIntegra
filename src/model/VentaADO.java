...
public class VentaADO {
    ...
    public static ResultTransaction registrarVentaContado(VentaTB ventaTB, ArrayList<SuministroTB> tvList, boolean privilegio) {
        ...
        try {
            ...
            if (privilegio && countValidate > 0) {
                ...
                venta.setDouble(12, ventaTB.getImporteBruto());
                venta.setDouble(13, ventaTB.getDescuento());
                venta.setDouble(14, ventaTB.getImpuesto());
                venta.setDouble(15, ventaTB.getImporteNeto());
                ...
                venta.setDouble(23, ventaTB.getDeposito());
                venta.setString(24, ventaTB.getNumeroOperacion());
                venta.addBatch();
                ...
                if (ventaTB.getDeposito() > 0) {
                    ...
                    if (ventaTB.getEfectivo() > 0) {
                        ...
                        ingreso.setString(6, ventaTB.getHoraVenta());
                        ingreso.setInt(7, 1);
                        ingreso.setDouble(8, ventaTB.getTarjeta() > 0 ? ventaTB.getEfectivo() : ventaTB.getImporteNeto());
                        ingreso.addBatch();
                    }
    ...
    public static ResultTransaction registrarVentaContadoPosVenta(VentaTB ventaTB, ArrayList<SuministroTB> tvList, boolean privilegio) {
        CallableStatement serie_numeracion = null;
        CallableStatement codigoCliente = null;
        CallableStatement codigo_venta = null;
        PreparedStatement venta = null;
            ...
            if (privilegio && countValidate > 0) {
                ...
                if (ventaTB.getDeposito() > 0) {
                    ...
                    if (ventaTB.getEfectivo() > 0) {
                        ...
                        movimiento_caja.setDouble(6, ventaTB.getTarjeta() > 0 ? ventaTB.getEfectivo() : ventaTB.getImporteNeto());
                        movimiento_caja.setString(7, id_venta);
                        movimiento_caja.addBatch();
                    }
    ...
    public static ResultTransaction registrarVentaAdelantadoPosVenta(VentaTB ventaTB, ArrayList<SuministroTB> tvList) {
        CallableStatement serie_numeracion = null;
        CallableStatement codigoCliente = null;
        CallableStatement codigo_venta = null;
        PreparedStatement venta = null;
    ...
    public static ResultTransaction registrarVentaCreditoPosVenta(VentaTB ventaTB, ArrayList<SuministroTB> tvList, boolean privilegio) {
        CallableStatement serie_numeracion = null;
        CallableStatement codigoCliente = null;
        CallableStatement codigo_venta = null;
        PreparedStatement venta = null;
    ...
    public static Object ListVentasAll(int opcion, String value, String fechaInicial, String fechaFinal, int estado, int posicionPagina, int filasPorPagina) {
        ...
        try {
            ...
            preparedStatement = DBUtil.getConnection().prepareStatement("SELECT \n"
                    ...
                    + "WHERE CAST(v.FechaVenta AS DATE) BETWEEN ? AND ? AND v.Tipo = 1 AND v.Estado <> 3 and nc.IdNotaCredito is null and v.Procedencia = 1");
    ...
    public static Object ListVentasLibres(int opcion, String value, String fechaInicial, String fechaFinal, int comprobante, int estado, String usuario, int posicionPagina, int filasPorPagina) {
        PreparedStatement preparedStatement = null;
        ResultSet rsEmps = null;
        try {
            DBUtil.dbConnect();
            ...
            preparedStatement = DBUtil.getConnection().prepareStatement("SELECT \n"
                    ...
                    + "INNER JOIN DetalleVentaTB as dv on dv.IdVenta = v.IdVenta\n"
                    + "LEFT JOIN NotaCreditoTB as nc on nc.IdVenta = v.IdVenta\n"
                    + "WHERE CAST(v.FechaVenta AS DATE) BETWEEN ? AND ? AND v.Tipo = 1 AND v.Estado = 1 and nc.IdNotaCredito is null and v.Procedencia = 1\n"
                    + "OR CAST(v.FechaVenta AS DATE) BETWEEN ? AND ? AND v.Tipo = 1 AND v.Estado = 4 and nc.IdNotaCredito is null and v.Procedencia = 1");
            preparedStatement.setString(1, fechaInicial);
            preparedStatement.setString(2, fechaFinal);
            preparedStatement.setString(3, fechaInicial);
            preparedStatement.setString(4, fechaFinal);
    ...
    public static Object ListCompletaVentasDetalle(String idVenta) {
        ...
        try {
            ...
            if (resultSetVenta.next()) {
                ...
                ventaTB.setImporteBruto(resultSetVenta.getDouble("SubTotal"));
                ventaTB.setDescuento(resultSetVenta.getDouble("Descuento"));
                ventaTB.setSubImporteNeto(resultSetVenta.getDouble("SubImporte"));
                ventaTB.setImpuesto(resultSetVenta.getDouble("Impuesto"));
                ventaTB.setImporteNeto(resultSetVenta.getDouble("Total"));
                ...
                statementEmpresa = DBUtil.getConnection().prepareStatement("SELECT TOP 1 d.IdAuxiliar,e.NumeroDocumento,e.RazonSocial,e.NombreComercial,e.Domicilio,e.Telefono,e.Email FROM EmpresaTB AS e INNER JOIN DetalleTB AS d ON e.TipoDocumento = d.IdDetalle AND d.IdMantenimiento = '0003'");
    ...
    public static String CancelTheSalePosVenta(String idVenta, ObservableList<SuministroTB> arrList, String motivo) {
        PreparedStatement statementValidar = null;
        PreparedStatement statementVenta = null;
        PreparedStatement statementSuministro = null;
        PreparedStatement statementKardex = null;
...
//                    }
    ...
    public static Object ImprimirVetanCreditoById(String idVenta, String idVentaCredito) {
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        try {
            DBUtil.dbConnect();
