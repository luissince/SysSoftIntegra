...
public class SelectionOverlay extends Region {
    ...
    private void monitorBounds() {
        ...
        boundsChangeListener = (ObservableValue<? extends Bounds> observableValue, Bounds oldBounds, Bounds newBounds) -> {
    ...
    private void enableDrag(final DragHandle dragHandle) {
        ...
        dragHandle.setOnMouseReleased((MouseEvent mouseEvent) -> {
            getScene().setCursor(Cursor.DEFAULT);
            
            mouseEvent.consume();
        });
        dragHandle.setOnMouseDragged((MouseEvent mouseEvent) -> {
        ...
        dragHandle.setOnMouseEntered((MouseEvent mouseEvent) -> {
        ...
        dragHandle.setOnMouseExited((MouseEvent mouseEvent) -> {
            if (!mouseEvent.isPrimaryButtonDown()) {
                getScene().setCursor(Cursor.DEFAULT);
            }
        });
