...
public class FxPostVentaDevolucionController implements Initializable {
    ...
    public void setInitVentaDetalle(FxPostVentaDetalleController ventaDetalleController) {
        this.ventaDetalleController = ventaDetalleController;
    }

    public void setInitVentaMostrar(FxPostVentaMostrarController ventaMostrarController) {
