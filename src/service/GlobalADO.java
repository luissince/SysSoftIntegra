...
public class GlobalADO {
    ...
    public static ArrayList<Double> ReporteGlobal(String fechaInicial, String fechaFinal) {
        ...
        try {
            ...
            // utilidad
            preparedGlobal = dbf.getConnection().prepareStatement("select\n"
                    + "case\n"
    ...
    public static Object DashboardLoad(String fechaActual) {
        ...
        try {
            ...
            try (PreparedStatement ptVentas = dbf.getConnection().prepareStatement("SELECT\n"
            ...
            try (PreparedStatement ptCompras = dbf.getConnection().prepareStatement("SELECT\n"
            ...
            try (PreparedStatement ptCuentasCobrar = dbf.getConnection().prepareStatement("SELECT COUNT(*) AS Total\n"
            ...
            PreparedStatement ptHistorialVentas = dbf.getConnection().prepareStatement("SELECT \n"
            ...
            PreparedStatement ptHistorialVentasTipos = dbf.getConnection().prepareStatement("SELECT \n"
                    + "MONTH(vt.FechaVenta) AS Mes, \n"
            ...
            PreparedStatement ptTipoVenta = dbf.getConnection().prepareStatement("SELECT \n"
                    + "CASE \n"
            ...
            PreparedStatement ptProductosMasVecesVendidos = dbf.getConnection().prepareStatement("SELECT \n"
                    + "TOP 10\n"
                    + "s.IdSuministro,\n"
                    + "s.Clave,\n"
                    + "s.NombreMarca,\n"
            ...
            PreparedStatement ptProductosMasCantidadesVendidos = dbf.getConnection().prepareStatement("SELECT \n"
                    + "TOP 10\n"
                    + "s.IdSuministro,\n"
                    + "s.Clave,\n"
                    + "s.NombreMarca,\n"
    ...
    public static String RegistrarInicioPrograma(EmpresaTB empresaTB, MonedaTB monedaTB, EmpleadoTB empleadoTB,
        ...
        try {
            ...
            codigoEmpleado = dbf.getConnection().prepareCall("{? = call Fc_Empleado_Codigo_Alfanumerico()}");
            ...
            codigoAlmacen = dbf.getConnection().prepareCall("{? = call Fc_Almacen_Codigo_Numerico()}");
            ...
            statementProveedor = dbf.getConnection().prepareCall("INSERT INTO "
                    + "ProveedorTB("
                    + "IdProveedor,"
                    + "TipoDocumento,"
                    + "NumeroDocumento,"
